...
alias mv="mv -i"
alias rm="rm -i"
alias fa="cd ~/.local/bin/ && ./fm6000 -f ast.txt && cd"
alias fw="cd ~/.local/bin/ && ./fm6000 -f wolf.txt && cd"
alias f="~/.local/bin/fm6000"
alias px="pdflatex"
...
cat /home/luispengler/.cache/wal/sequences
